            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="{{route('producto.update', $producto)}}" method="post">
                        @if ($errors->any())
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" id="name" name="nombre" class="form-control" value="{{$producto -> nombre}}">
                                        <span class="form-bar"></span>
                                        <label>Ingresa nuevo nombre producto</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" id="cantidad" name="cantidad" value="{{$producto -> cantidad}}" class="form-control"/>
                                        <span class="form-bar"></span>
