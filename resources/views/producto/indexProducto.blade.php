                    ...
                    <ul class="nav-right">
                                    ...
                                    <ul class="show-notification profile-notification">
                                        <li class="waves-effect waves-light">
                                            <a href="/producto/create">
                                                <i class="ti-user"></i> Agregar Producto
                                            </a>
                                        </li>
                                        <li class="waves-effect waves-light">
                                            <a href="/inicio">
                                                <i class="ti-settings"></i> Volver Inicio
                                            </a>
                                        </li>
                                        <li class="waves-effect waves-light">
                                            @auth
                        ...
                        <ul>
                            @foreach ($producto as $producto) 
                                <h2 class = "text-center"><a href="{{route('producto.show', $producto)}}">{{$producto -> nombre}}</a></h2>
                                <div class="contenedor-botones">
                                    <a href="{{route('producto.edit', $producto)}}" class="btn btn-outline-info">Editar</a>
