            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="{{route('cliente.update', $cliente)}}" method="post">
                        @if ($errors->any())
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" id="name" name="nombre" class="form-control" value="{{$cliente -> nombre}}">
                                        <span class="form-bar"></span>
                                        <label>Ingresa nuevo nombre cliente</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" id="cantidad" name="cantidad" value="{{$cliente -> cantidad}}" class="form-control"/>
                                        <span class="form-bar"></span>
                                        <label>Ingresa nueva cantidad</label>
                                    </div>
                                    <div class="form-group form-primary">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="producto_men" id="producto_men"  name="producto_men" value="{{$cliente -> producto_men}}" class="form-control"/>
                                        <span class="form-bar"></span>
