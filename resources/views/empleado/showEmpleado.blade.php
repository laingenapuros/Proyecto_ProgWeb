...
>>>>>>> b54f8bbfcf5740ed700706eabb34180497f1d841
                        ...
                        @auth
                        <h1 class="text-center" > Bienvenido empleado  {{Auth::user()->name}}</h1>
                        @endauth
                    
                        <div class="col-md-12">
                            <h3 class="text-center">Vista de empleado </h3>
                            
                           
                            
                            <p class="text-center">  <img  width="30" height="30" src="{{asset('plant/images/empl.png')}}" /> Nombre empleado: {{$empleado -> nombre}}  </p>
                            <p class="text-center"> <img  width="30" height="30" src="{{asset('plant/images/llamada.png')}}" />Telefono Empleado: {{ $empleado->telefono }}</p>
                            <p class="text-center" > <img  width="30" height="30" src="{{asset('plant/images/email.png')}}" />Correo Empleado: {{ $empleado->correo }}</p>
