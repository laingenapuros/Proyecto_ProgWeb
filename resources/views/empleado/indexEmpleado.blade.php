                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            @foreach ($empleado as $empleado)
                             <h2 class="text-center">  <img  width="30" height="30" src="{{asset('plant/images/usuario.png')}}" /> <a href="{{route('empleado.show', $empleado)}}"> {{$empleado -> nombre}} </a>  </h2>
                             <div class="contenedor-botones">
    <a href="{{ route('empleado.edit', $empleado) }}" class="btn btn-outline-info">Editar</a>
