                    ...
                    @method('PATCH')
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <input type="text" id="name" name="nombre" class="form-control" value="{{$empleado->nombre}}">
                                        <span class="form-bar"></span>
                                        <label >Ingresa tu nuevo nombre</label>
                                        
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" id="telefono" name="telefono" class="form-control" value="{{$empleado->telefono}}">
                                        <span class="form-bar"></span>
                                    ...
                                    <div class="form-group form-primary">
                                    <input  id="password"  name="password" value="{{$empleado->password}}" class="form-control"/>
                                        <span class="form-bar"></span>
