...
<head>
    <title>Create requerimiento</title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="{{route ('requerimiento.store')}}" method="post">
                            @if ($errors->any())
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Agregar Requerimiento</h3>
                                        </div>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" id="identificador" name="identificador" class="form-control" value="{{old ('identificador')}}">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Ingresa Identificador</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" id="parrafo" name="parrafo" value="{{old ('parrafo')}}" class="form-control"/>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Ingresa descripción</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <label for="cliente_id">Ingresa el cliente</label>
